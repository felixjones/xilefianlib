...
.syntax unified
    ...
    .section .iwram.xilefian_m4col_pack2, "ax", %progbits
    .global xilefian_m4col_pack2
    .type xilefian_m4col_pack2, %function
xilefian_m4col_pack2:
...
.Lpack2_loop:
    ...
    .section .iwram.xilefian_m4col_unpack2, "ax", %progbits
    .global xilefian_m4col_unpack2
    .type xilefian_m4col_unpack2, %function
xilefian_m4col_unpack2:
...
.Lunpack2_loop:
    ...
    .section .iwram.xilefian_m4col_pack4, "ax", %progbits
    .global xilefian_m4col_pack4
    .type xilefian_m4col_pack4, %function
xilefian_m4col_pack4:
    @ r0 = vram, r1 = source, r2 = number of rows (multiple of 4, non-zero)
    push    {r4-r7}
...
.Lpack4_loop:
    ...
    .section .iwram.xilefian_m4col_unpack4, "ax", %progbits
    .global xilefian_m4col_unpack4
    .type xilefian_m4col_unpack4, %function
xilefian_m4col_unpack4:
    @ r0 = destination, r1 = vram, r2 = number of rows (multiple of 4, non-zero)
    push    {r4-r7}
